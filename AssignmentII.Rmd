...
loo_cv = function(Y,X, ridge_regression=TRUE){
  ...
  for( i in 1:n){
    ...
    #cv_grid[,1] = x_validation_set
    # Use first column as coefficient column
    #cv_error_grid[, 1] = x_validation_set
...
ridge_loo_cv_result = loo_cv(Y_train,X_train,ridge_regression=TRUE)
...
lasso_loo_cv_result = loo_cv(Y_train,X_train,ridge_regression=FALSE)
